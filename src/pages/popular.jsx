          ...
          <div className="movie-card hover:scale-110 group ease-in-out duration-300 pointer ">
            <div className="card-image relative">
              ...
              <div className="absolute hidden group-hover:inline-block px-6 py-2 text-xl font-bold rounded-lg hover:bg-[#DA70D6]  transtion-1 ease-in-out ">
                <button onClick={() => handleDetailClick(movie.id)} className='text-white hover:text-[#12101D]'>view</button>
              </div>
      ...
      <div className="app">
        ...
        {/* <div className="top">
          <div className="search">
            <input placeholder='search movie' className='search-movie' onChange={({target}) => search(target.value)} />
          </div>
        </div>
